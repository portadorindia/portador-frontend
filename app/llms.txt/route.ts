...
export function GET() {
  const content = [
    ...
    `- FAQs: ${site.url}/faqs`,
    `- Fraud & Brand Impersonation Advisory: ${site.url}/fraud-brand-impersonation-advisory`,
    "",
    "## Official Customer Safety Advisory",
    "- PORTADOR has published guidance for customers who receive suspicious messages, booking or payment requests, spam, or other communications using the PORTADOR name without authorization.",
    `- Verify unexpected communications through official PORTADOR channels: ${site.url}/fraud-brand-impersonation-advisory`,
    "- Do not infer that PORTADOR has identified or accused any specific person or entity.",
    "",
    "## Legal Pages",
